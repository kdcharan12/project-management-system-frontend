...
export default function IssueDetails() {
  ...
  return (
    ...
    <Navbar/>
    <div className="px-20  py-10 text-black-200">
      <div className="flex justify-between border  p-10 rounded-lg" style={{border:"1px solid black"}}>
        <ScrollArea className="h-[70vh] w-[60%]">
          <div>
            <h1 className="text-lg font-semibold text-black-100">Create navbar</h1>
            <div className="py-5">
              <h2 className="font-semibold text-black-200 ">
                Description
              </h2>
              <p className=" text-black-300 text-sm mt-3">
                Track your aactivity 
              </p>
            </div>
            <div className="mt-5">
