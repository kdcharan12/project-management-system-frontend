        ...
        <div className="lg:flex  gap-5 justify-between pb-4">
          <ScrollArea className="h-[89vh]  lg:w-[69%] pr-2 ">
            <div className=" p w-full pr-8 pl-8 "  style={{paddingRight:"8px", paddingLeft:"8px"}} >
              <h1 className="text-lg font-smeibold pb-5" style={{color:"#000"}}>Create Ecommerce Website Using React</h1>
              ...
              <div  className="flex">
                <p style={{color:"#000"}} className="w-36">Members :</p>
                ...
                <Dialog>
                  ...
                  <DialogContent style={{backgroundColor:"#171717f4"}}>
                    <DialogHeader>
                      <DialogTitle style={{color:"#000"}}>Invite user</DialogTitle>
                      <InviteUserForm/>
                    </DialogHeader>
                  </DialogContent>
                </Dialog>
              ...
              <div className="flex">
                <p style={{color:"#000"}} className="w-36">Status :</p>
                <Badge style={{background:"black"}}><p>Pending</p></Badge>

              </div>
            </div>

            <section className="pr-100">
              <p style={{color:"#000"}} className="tasksFont py-5 border-b text-lg -tracking-wider ">Tasks</p>
